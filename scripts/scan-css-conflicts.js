...
function generateReport() {
 ...
 console.log(`\n DUPLICATE PROPERTIES: ${results.duplicateProperties.length} instances\n`);
 ...
 console.log(`\n !IMPORTANT OVERUSE: ${results.importantOveruse.length} instances\n`);
 ...
 console.log(`\n HIGH SPECIFICITY: ${results.highSpecificity.length} selectors\n`);
 ...
 console.log(`\n UNDEFINED CSS VARIABLES: ${results.undefinedVars.length} instances\n`);
 ...
 console.log(`\n Z-INDEX CONFLICTS: ${conflictingZIndexes.length} values used by multiple elements\n`);
 ...
 console.log(`\n INLINE STYLES IN TSX: ${results.inlineStyles.length} instances\n`);
