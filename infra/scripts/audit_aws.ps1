...
aws iam list-roles --query "Roles[?contains(RoleName, 'sensapbl')].RoleName"
...
Get-ChildItem "c:\Users\nathi\OneDrive\Documents\Projects\SensaPBL\infra\terraform\modules" -Recurse -Filter "main.tf" | Select-String "resource" | Select-Object Path, LineNumber, Line | Format-List
