...
CONCEPTS_TABLE = os.environ.get("CONCEPTS_TABLE", "SensaAI-concepts-pilot")
JOBS_TABLE = os.environ.get("JOBS_TABLE", "SensaAI-jobs-pilot")
...
def handle_list_subjects(user_id: str, event: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def handle_delete_subject(user_id: str, session_id: str, event: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    return api_response(200, {
        ...
        "itemsDeleted": len(items_to_delete) + 1
    }, event)


def handle_get_job_progress(user_id: str, job_id: str, event: Dict[str, Any]) -> Dict[str, Any]:
    """
