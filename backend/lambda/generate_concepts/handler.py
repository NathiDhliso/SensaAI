...
def _handle_generate(request: Dict[str, Any]) -> Dict[str, Any]:
    """
    Handle concept generation request.
    
    Orchestrates:
    1. Job creation in DynamoDB
    2. Concept generation via Bedrock
    3. Concept storage in DynamoDB
    4. Job status update
    ...
    # Step 2: Generate concepts with Bedrock
    print(f"[Handler] Starting Bedrock generation...")
    try:
    ...
    # Step 3: Store concepts in DynamoDB
