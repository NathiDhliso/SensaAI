...
class DynamoService:
    ...
    DEFAULT_CONCEPT_TTL_HOURS = 168

    def __init__(self):
        """Initialize DynamoDB service with table references."""
        self.dynamodb = boto3.resource("dynamodb")
        self.jobs_table_name = os.environ.get("JOBS_TABLE", "SensaAI-jobs-pilot")
        self.concepts_table_name = os.environ.get("CONCEPTS_TABLE", "SensaAI-concepts-pilot")
