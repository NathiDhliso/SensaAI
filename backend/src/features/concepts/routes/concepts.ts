...
const CONCEPTS_TABLE = process.env.CONCEPTS_TABLE || 'SensaAI-concepts-pilot';
const JOBS_TABLE = process.env.JOBS_TABLE || 'SensaAI-jobs-pilot';
const GENERATE_FUNCTION = process.env.GENERATE_LAMBDA || 'SensaAI-generate-concepts-pilot';
