 ...
 * AI Coach Service
 * 
 * Central service for AI coaching functionality.
 * Handles persona selection, response generation, and phase awareness.
 */
...
export type { PersonaId, PhaseKey, PhaseResponses };
export { getPersona, getPersonaResponse, getAllPersonas, PERSONAS };
...
class AICoachService {
    ...
    private currentPhase: PhaseKey = 'prime';
    ...
    setCurrentPhase(phase: PhaseKey) {
    ...
    /**
     * Get contextual response for current situation
     */
    getResponse(
        personaId: PersonaId,
