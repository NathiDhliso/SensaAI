...
import { COLORS, GRAPH_COLORS } from '@/shared/constants/theme-colors';
import type { TreePacket } from '@/shared/types/content-analytics';
    ...
    return (
        <motion.div
            ...
            style={{
                width: '100%',
                height: '100%',
                minHeight: '300px', // Enforce minimum height at the top level
                display: 'flex',
