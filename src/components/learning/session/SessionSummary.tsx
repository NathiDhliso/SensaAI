...
export function SessionSummary() {
 ...
 switch (rating) {
 case 'optimal': return { label: 'Optimal' };
 case 'good': return { label: 'Good' };
 case 'warning': return { label: 'Slow' };
 case 'overtime': return { label: 'Very Slow' };
 ...
 <div className={styles.statValue}>{paceDisplay.label}</div>
