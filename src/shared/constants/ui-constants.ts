...
// Cinematic "Inner Monologue" for the AI Agent
export const COGNITIVE_THOUGHTS = {
 pass1: [
 "SCANNING GLOBAL KNOWLEDGE BASE...",
 "PARSING 4.2 MILLION NODES FOR RELEVANCE...",
 "DETECTING SEMANTIC DENSITY...",
 "DISCARDING SUPERFICIAL DATA...",
 ...
 "FORGING NEW SYNAPTIC PATHWAYS...",
 "IDENTIFYING CORE TRUTHS...",
 "WEAVING CONTEXTUAL FABRIC...",
 "CALCULATING INFORMATION ENTROPY...",
 "OPTIMIZING RETENTION PATHS..."
 ],
 pass3: [
 "SYNTHESIZING CONCEPTS...",
 "CRYSTALLIZING ABSTRACT IDEAS...",
 "GENERATING MNEMONIC ANCHORS...",
 "ENFORCING COGNITIVE LOAD LIMITS...",
 "RESTRUCTURING FOR CLARITY...",
 "INJECTING EXPERT NUANCE...",
 "VALIDATING CONCEPTUAL HIERARCHY...",
 "FINALIZING NEURAL ARCHITECTURE..."
 ],
 pass4: [
 "RUNNING FINAL DIAGNOSTICS...",
 "VERIFYING STRUCTURAL COHERENCE...",
 "OPTIMIZING FOR HUMAN CONSUMPTION...",
 "ENSURING PEDAGOGICAL INTEGRITY...",
 "SYSTEM CHECK: PASS...",
 "PREPARING NEURAL UPLOAD...",
 "FINAL POLISH DETECTED...",
