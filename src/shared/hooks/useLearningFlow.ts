...
export type LearningPhase =
    ...
    | 'SCOUT' // Initial survey (DeepStructureDiscovery)
    | 'PREVIEW' // Question preview (DeepStructureDiscovery phase=preview)
...
export function useLearningFlow(): LearningFlow {
    ...
    const currentPhase = useMemo((): LearningPhase => {
        ...
        // But wait, ActiveLearningEngine had a "LockIn" logic. 
