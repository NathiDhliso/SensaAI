...
export type StudySliceActions = {
    ...
    setMood: (mood: 'pumped' | 'good' | 'okay' | 'struggling' | 'tired') => void;
    setSessionGoal: (goal: StudyGoal) => void;
    markSessionScouted: () => void;
    markSessionPreviewed: () => void;
    markSessionMapBuilt: (data?: ConceptMapData) => void;
    markOverviewViewed: () => void;
    ...
    /** Persist Learning Health equation values so they survive refresh */
    updateSessionEquation: (equation: LearningHealthEquation) => void;
